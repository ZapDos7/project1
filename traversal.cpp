...
void recursive_builder(int curve1_length, int curve2_length){
  ...
  {
    delete left; left = NULL; left_ok = false;
    delete center; center = NULL; center_ok = false;
  }

  if(zeugos.second == curve2_length-1) //ftasame sto telos ths 1hs kampylhs
  {
    delete right; right = NULL; right_ok = false;
    delete center; center = NULL; center_ok = false;
  }
