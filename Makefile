...
SOURCESCURVEGRIDHPR = curve_grid_hypercube.cpp
SOURCESCURVEGRIDLSH = curve_grid_lsh.cpp
SOURCESCURVEPRJHPR = curve_projection_hypercube.cpp
SOURCESCURVEPRJLSH = curve_projection_lsh.cpp
...
a4: $(SOURCESCURVEPRJHPR) $(EXECUTABLECURVEPRJHPR)

$(EXECUTABLECURVEPRJHPR): $(OBJECTSCURVEPRJHPR) 
	$(CC) $(LDFLAGS) $(OBJECTSCURVEPRJHPR) -o $@

#random projection-lsh
a5: $(SOURCESCURVEPRJLSH) $(EXECUTABLECURVEPRJLSH)
    
$(EXECUTABLECURVEPRJLSH): $(OBJECTSCURVEPRJLSH) 
	$(CC) $(LDFLAGS) $(OBJECTSCURVEPRJLSH) -o $@
...
clean:
	rm -f $(OBJECTS) $(EXECUTABLE) $(EXECUTABLECUBE) $(EXECUTABLECURVEGRIDHPR) $(EXECUTABLECURVEGRIDLSH) $(EXECUTABLECURVEPRJHPR) $(EXECUTABLECURVEPRJLSH)
