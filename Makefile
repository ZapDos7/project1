...
SOURCESCURVEGRIDHPR = curve_grid_hypercube.cpp curve.cpp curve_point.cpp cube_grid.cpp my_vector.cpp NNpair.cpp curve_cube_ht.cpp h_funs.cpp g_funs.cpp
SOURCESCURVEGRIDLSH = curve_grid_lsh.cpp curve_point.cpp curve.cpp grid.cpp my_vector.cpp NNpair.cpp curve_ht.cpp h_funs.cpp g_funs.cpp
